...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Log.d(Constants.TAG, "onCreate() method was relaunched");
            ...
            {
                EditText editTextUsername = findViewById(R.id.username_edit_text);
                editTextUsername.setText(savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT));
            }
            if (savedInstanceState.containsKey(Constants.PASSWORD_EDIT_TEXT))
            {
                EditText editText = findViewById(R.id.password_edit_text);
                editText.setText(savedInstanceState.getString(Constants.PASSWORD_EDIT_TEXT));
            }
        }
        else
        {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        CheckBox checkBox = findViewById(R.id.remember_me_checkbox);
        EditText editTextUsername = findViewById(R.id.username_edit_text);
        EditText editTextPass = findViewById(R.id.password_edit_text);
        if (checkBox.isChecked())
        {
            outState.putBoolean(Constants.REMEMBER_ME_CHECKBOX, checkBox.isChecked());
            outState.putString(Constants.USERNAME_EDIT_TEXT, editTextUsername.getText().toString());
            outState.putString(Constants.PASSWORD_EDIT_TEXT, editTextPass.getText().toString());
        }
    }
